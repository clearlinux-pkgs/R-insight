...
Version  : 0.18.7
Release  : 45
URL      : https://cran.r-project.org/src/contrib/insight_0.18.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/insight_0.18.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668789975
