...
Version  : 0.14.3
Release  : 23
URL      : https://cran.r-project.org/src/contrib/insight_0.14.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/insight_0.14.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629211980
