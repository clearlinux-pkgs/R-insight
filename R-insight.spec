...
Version  : 0.18.8
Release  : 46
URL      : https://cran.r-project.org/src/contrib/insight_0.18.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/insight_0.18.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669398585
