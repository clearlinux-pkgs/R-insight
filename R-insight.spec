...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/insight_1.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736522130
...
/usr/lib64/R/library/insight/tests/testthat/_snaps/windows/export_table.md
...
/usr/lib64/R/library/insight/tests/testthat/test-ggeffects.R
