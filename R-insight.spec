...
Version  : 0.13.1
Release  : 11
URL      : https://cran.r-project.org/src/contrib/insight_0.13.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/insight_0.13.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614016757
