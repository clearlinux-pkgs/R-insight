...
Version  : 0.9.6
Release  : 5
URL      : https://cran.r-project.org/src/contrib/insight_0.9.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/insight_0.9.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600708534
